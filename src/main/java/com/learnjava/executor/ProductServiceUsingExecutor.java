...
public class ProductServiceUsingExecutor {
    // Set up a fixed thread pool based on the number of available processors/cores
...
//        Review review = reviewService.retrieveReviews(productId); // blocking call
        ...
        /*
            * Blocking calls to get the results from the Future objects
            * These calls will wait until the respective tasks are completed
            * and the results are available.
         */
        ProductInfo productInfo = productInfoFuture.get();
        Review review = reviewFuture.get(30, TimeUnit.MILLISECONDS);
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        /*
            * GOTCHA!! Shutdown the executor service to release resources
            * This is important to prevent memory leaks and ensure
